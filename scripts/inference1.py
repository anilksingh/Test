...
def main(config, args):
    ...
    # Pass the skip_until_face flag to the pipeline
    pipeline(
        ...
        skip_until_face=args.skip_until_face  # <--- ADDED
    )
...
if __name__ == "__main__":
    ...
    # NEW FLAG FOR SKIPPING UNTIL FACE IS FOUND
    parser.add_argument("--skip_until_face", action="store_true", 
                        help="Skip frames until a face is found before processing.")
